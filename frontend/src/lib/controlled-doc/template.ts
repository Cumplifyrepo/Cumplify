/**
 * Controlled-document HTML templates — VENDORED COPY for frontend iframe rendering.
 *
 * Source of truth: services/pdf-export/src/template.ts
 * Parity enforced by: frontend/src/test/controlled-doc-parity.test.ts
 * Per ims-experience/view-designs.md §9.6: both copies MUST stay in sync.
 *
 * Original header (STO-3, spec-40 Task 9):
