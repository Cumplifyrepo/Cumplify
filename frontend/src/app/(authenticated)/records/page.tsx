...
/**
 * Records module lands in P4; the working M4 calibration/trail register serves until absorption (architecture §11).
 ...
 */
export default function RecordsInterimRedirect() {
