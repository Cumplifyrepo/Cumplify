...
const AUTHORITATIVE_CLAUSE_REFS: readonly string[] = [
  // ISO 9001 (50)
  'ISO 9001 4.1', 'ISO 9001 4.2', 'ISO 9001 4.3', 'ISO 9001 4.4',
  'ISO 9001 5.1', 'ISO 9001 5.2', 'ISO 9001 5.3',
  'ISO 9001 6.1', 'ISO 9001 6.2', 'ISO 9001 6.3',
  'ISO 9001 7.1.1', 'ISO 9001 7.1.2', 'ISO 9001 7.1.3', 'ISO 9001 7.1.4',
  'ISO 9001 7.1.5', 'ISO 9001 7.1.6', 'ISO 9001 7.2', 'ISO 9001 7.3',
  'ISO 9001 7.4', 'ISO 9001 7.5',
  'ISO 9001 8.1', 'ISO 9001 8.2.1', 'ISO 9001 8.2.2', 'ISO 9001 8.2.3',
  'ISO 9001 8.2.4', 'ISO 9001 8.3.1', 'ISO 9001 8.3.2', 'ISO 9001 8.3.3',
  'ISO 9001 8.3.4', 'ISO 9001 8.3.5', 'ISO 9001 8.3.6', 'ISO 9001 8.4.1',
  'ISO 9001 8.4.2', 'ISO 9001 8.4.3', 'ISO 9001 8.5.1', 'ISO 9001 8.5.2',
  'ISO 9001 8.5.3', 'ISO 9001 8.5.4', 'ISO 9001 8.5.5', 'ISO 9001 8.5.6',
  'ISO 9001 8.6', 'ISO 9001 8.7',
  'ISO 9001 9.1.1', 'ISO 9001 9.1.2', 'ISO 9001 9.1.3', 'ISO 9001 9.2', 'ISO 9001 9.3',
  'ISO 9001 10.1', 'ISO 9001 10.2', 'ISO 9001 10.3',
  // ISO 14001 (26)
  'ISO 14001 4.1', 'ISO 14001 4.2', 'ISO 14001 4.3', 'ISO 14001 4.4',
  'ISO 14001 5.1', 'ISO 14001 5.2', 'ISO 14001 5.3',
  'ISO 14001 6.1.1', 'ISO 14001 6.1.2', 'ISO 14001 6.1.3', 'ISO 14001 6.1.4',
  'ISO 14001 6.2',
  'ISO 14001 7.1', 'ISO 14001 7.2', 'ISO 14001 7.3', 'ISO 14001 7.4', 'ISO 14001 7.5',
  'ISO 14001 8.1', 'ISO 14001 8.2',
  'ISO 14001 9.1.1', 'ISO 14001 9.1.2', 'ISO 14001 9.2', 'ISO 14001 9.3',
  'ISO 14001 10.1', 'ISO 14001 10.2', 'ISO 14001 10.3',
  // ISO 45001 (32)
  'ISO 45001 4.1', 'ISO 45001 4.2', 'ISO 45001 4.3', 'ISO 45001 4.4',
  'ISO 45001 5.1', 'ISO 45001 5.2', 'ISO 45001 5.3', 'ISO 45001 5.4',
  'ISO 45001 6.1.1', 'ISO 45001 6.1.2.1', 'ISO 45001 6.1.2.2', 'ISO 45001 6.1.2.3',
  'ISO 45001 6.1.3', 'ISO 45001 6.1.4', 'ISO 45001 6.2',
  'ISO 45001 7.1', 'ISO 45001 7.2', 'ISO 45001 7.3', 'ISO 45001 7.4', 'ISO 45001 7.5',
  'ISO 45001 8.1.1', 'ISO 45001 8.1.2', 'ISO 45001 8.1.3', 'ISO 45001 8.1.4', 'ISO 45001 8.2',
  'ISO 45001 9.1.1', 'ISO 45001 9.1.2', 'ISO 45001 9.2', 'ISO 45001 9.3',
  'ISO 45001 10.1', 'ISO 45001 10.2', 'ISO 45001 10.3',
  // HLS (1)
  'Annex SL HLS',
] as const;
